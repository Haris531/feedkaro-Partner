        ...
        <>
            <div className='flex flex-row justify-between mt-8 mb-12 pl-8'>
                <div className='flex flex-row justify-center items-center'>
                    ...
                    <Link to='/prime' className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center">
                        <FaGreaterThan size={15} className='mx-2' />S.P' Prime Sale Partners</Link>
                        <Link to='/spaffiliates2' className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center">
                        <FaGreaterThan size={15} className='mx-2' />S.P' Affiliates</Link>
                        <Link to='/spaffiliatesorder2' className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center">
