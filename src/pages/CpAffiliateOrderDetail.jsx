        ...
        <>
            <div className='flex flex-row justify-between mt-8 mb-12 pl-14'>
                <div className='flex flex-row justify-center items-center'>
                    ...
                    <Link to='/custompartner' className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center">
                        <FaGreaterThan size={15} className='mx-2' />C.P Customer Partners</Link>
                        <Link to='/affiliates' className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center">
                        <FaGreaterThan size={15} className='mx-2' />C.P Affiliates</Link>
                        <Link to='/affiliateorder' className="mr-5 text-[#43A0AF] text-xl font-medium opacity-[50%] flex flex-row items-center">
